...
fun PasskeysScreen(onBack: () -> Unit) {
    Scaffold(
        topBar = { SettingsTopAppBar("Passkeys", onBack) },
        ...
        Column(
            ...
            PasskeyBenefitItem(Icons.Default.CheckCircle, "Create a passkey for a secure, easy way to log into your account.")
            PasskeyBenefitItem(Icons.Default.Fingerprint, "Log into WhatsApp with your face, fingerprint or screen lock.")
            PasskeyBenefitItem(Icons.Default.Key, "Your passkey is stored safely in your password manager.")
        }
    }
}
